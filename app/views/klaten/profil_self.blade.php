...
@section('script_bawah')
 <script>
    ...
    function pilihMode()
    {
        ...
        if ( pilihan == "1"){
        responsiveVoice.speak('Pasangan nomor urut satu,  MUKHAMMAD ARIFIN DAN ROMI INDIARTO, Mukhammad arifin merupakan alumni Politeknik Muhammadiyah Karanganyar dan saat ini merupakan Direktur PT. Kimia Kinerja Utama sedangkan Romi Indiarto merupakan alumni Universitas Gadjah Mada dan saat ini berprofesi sebagai wiraswasta. Visi pasangan ini adalah " Terwujudnya Kabupaten Pemalang yang Maju, Sejahtera, Sehat, Mandiri dan Bermartabat"  untuk mewujudkan visi tersebut pasangan ini memiliki misi sebagai berikut, 1.Mewujudkan masyarakat yang sehat, sejahtera, terdidik dan agamis, 2. Membangun pusat-pusat pertumbuhan wilayah baru, Sentra Industri terpadu dengan dukungan infrastruktur yang memadai, 3. Mewujudkan pemerintahan daerah yang profesional, melayani, amanah, bersih, wibawa, dan transparan,', 'Indonesian Female');

        }  else if (pilihan == "2") {
       
          
        responsiveVoice.speak('Pasangan nomor urut dua,  JUNAEDI DAN MARTONO,  Junaedi merupakan alumni UNTAG Semarang dan Program Pascasarjana di Sekolah tinggi ilmu ekonomi Stikubank Semarang. Dia merupakan bupati pemalang untuk periode 2011 sampai 2016. Sedangkan Martono merupakan alumni Universitas Pancasakti Tegal. Saat ini Martono berprofesi sebagai Sekretaris komisi C dan petani tambak. Visi pasangan ini adalah "Terwujudnya pemalang hebat yang berdaulat, berjatidiri, mandiri dan sejahtera", untuk mewujudkan visi tersebut mereka memiliki misi sebagai berikut, 1. Menjunjung tinggi kedaulatan rakyat melalui permusyawaratan perwakilan dari semua tingkatan dengan mengedepankan prinsip pembangunan partisipatif dan gotong royong, 2. Mewujudkan kesempatan dan kualitas pendidikan dan kesehatan yang merata dan berkeadilan, 3. Meneguhkan ekonomi kerakyatan berbasis pertanian, kelautan, perdagangan serta usaha kecil dan menengah serta upaya penanggulangan kemiskinan, 4. Mewujudkan sarana dan prasarana dasar yang merata untuk memperkuat sentra-sentra produksi berbasis kewilayahan sesuai dengan karakteristik dan potensi daerah, 5. Mewujudkan tata kelola pemerintahan yang bersih, efektif, demokratis, terpercaya, dan reformasi sistem yang bebas korupsi, bermartabat serta memberikan kemudahan investasi dalam upaya meningkatkan daya saing daerah, 6. Menumbuhkan kembali Budaya Asli Daerah Kabupaten Pemalang sebagai landasan pembentukan jati diri pemalang untuk memperkokoh kepribadian bangsa, 7. Memberikan rasa aman kepada masyarakat dan memperkokoh kebhinekaan dengan mengembangkan norma kehidupan beragama yang toleran, harmonis dan saling menghormati dengan didasarkan pada prinsip Ketuhanan Yang Maha Esa,', 'Indonesian Female');
    
         }  else if (pilihan == "3") {

          responsiveVoice.speak('Pasangan nomor urut tiga, MUKTI AGUNG WIBOWO  dan AFIFUDIN, Mukti Agung wibowo merupakan alumni Universitas Tri Sakti dan Pascasarjana Universitas Diponegoro. Saat ini dia merupakan wakil bupati pemalang untuk periode 2011 sampai 2016. Sedangkan Afifudin merupakan alumni Universitas Borobudur Jakarta dan program pasca sarjana ilmu politik Universitas Negeri Jakarta. Dia berprofesi sebagai tim ahli kementrian pendayagunaan aparatur negara dan reformasi birokrasi. Visi pasangan ini adalah "PEMALANG, MAS, yaitu Terwujudnya masyarakat Makmur, Aman dan Sejahtera yang di ridhoi oleh Allah SWT", untuk mewujudkan visi tersebut mereka memiliki misi sebagai berikut,    1.Meningkatkan Sumber Daya Manusia, 2. Memanfaatkan dan Optimalisasi Sumber Daya Alam, 3. Meningkatkan Kegiatan Industri , Jasa dan Pariwisata, 4. Menyelenggarakan Pemerintahan yang efisien, efektif, bersih dan demokratis sebagai upaya perwujudan Reformasi Birokrasi', 'Indonesian Female');
          ...
          window.location.href = "pilihanmenu"
             ...
             responsiveVoice.speak('Opsi yang anda pilih salah, silahkan ulangi kembali. TEKAN angka 1 untuk mengetahui profil pasangan nomor 1, TEKAN 2 untuk mengetahui profil pasangan nomor 2, TEKAN 3 untuk mengetahui profil pasangan nomor 3, tekan 4 untuk  kembali ke halaman pemilihan informasi','Indonesian Female');
         }   

      }   
    function selamatDatang() {
    
    responsiveVoice.speak('Selamat datang di halaman daftar peserta Pilkada Pemalang 2015. TEKAN angka 1 untuk mengetahui profil pasangan nomor 1, TEKAN 2 untuk mengetahui profil pasangan nomor 2, TEKAN 3 untuk mengetahui profil pasangan nomor 3, tekan 4 untuk  kembali ke halaman pemilihan informasi','Indonesian Female');
    }; 
    </script>
@endsection