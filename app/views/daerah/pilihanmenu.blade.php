...
function pilihMode()
    {
        ...
        window.location.href = "{{URL::to($kota)}}";

         }else{
           
             
            responsiveVoice.speak('Opsi yang anda pilih salah, tekan 1 jika anda ingin mencari tahu informasi mengenai Pilkada,  tekan 2 jika anda ingin mengetahui profil kandidat pada Pilkada 2015, tekan 3, jika anda ingin kembali ke halaman sebelumnya ','Indonesian Female');
          }
...
responsiveVoice.OnVoiceReady = function() {
  console.log("speech time?");
   ...
   responsiveVoice.speak('Silahkan pilih menu yang anda inginkan, tekan 1 jika anda ingin mencari tahu informasi mengenai Pilkada, tekan 2 jika anda ingin mengetahui profil kandidat pada Pilkada 2015, tekan 3, jika anda ingin kembali ke halaman sebelumnya','Indonesian Female');
