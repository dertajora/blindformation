...
<!-- /Section: intro -->
    ...
    <section id="about" class="home-section text-center">
        ...
        <div class="row">
			...
			<a href="<?php echo $kota."/pendampingan"?>"><div class="col-xs-6 col-sm-3 col-md-3">
				
                <div class="team boxed-grey">
                    <div class="inner">
						<h5>PENDAMPINGAN</h5>
                        <!-- <p class="subtitle">Bersama Pendamping</p> -->
                        <div class="avatar"><img src="{{asset('img/team/pendamping.jpg')}}" alt="" class="img-responsive" /></div>

                    </div>
                </div>
				
            </div></a>
            <a href="<?php echo $kota."/pilihanmenu"?>">
			<div class="col-xs-6 col-sm-3 col-md-3">
                ...
                <div class="team boxed-grey">
                    <div class="inner">
                        ...
                        <div class="avatar"><img src="{{asset('img/team/sendiri.jpg')}}"  alt="" class="img-responsive" /></div>
...
function pilihMode()
    {
        ...
        window.location.href = "<?php echo $kota."/pendampingan"?>"

        }  else if (pilihan == "2") {
       
         window.location.href = "<?php echo $kota."/pilihanmenu"?>"
