...
<!-- /Section: intro -->
    ...
    <section id="about" class="home-section text-center">
        ...
        <div class="row">
			...
			<a href="surabaya/pendampingan"><div class="col-xs-6 col-sm-3 col-md-3">
...
function pilihMode()
    {
        ...
        window.location.href = "surabaya/pendampingan"

        }  else if (pilihan == "2") {
       
         window.location.href = "surabaya/pilihanmenu"
